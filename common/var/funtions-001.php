...
function fireExit($xaddress,$xtext,$zClass){   
   echo "<div class='icon-a'><a href='https://" . $xaddress . "' target='_parent'><img src='common/media/port-0.jpg' border='0' class='icon-b'>";
   echo "<b>" . $xtext . "</b></a>"; 
...
function fireIcon($xaddress, $xtext, $picname, $zMite){   
  echo "<div class='icon-a'><a href='" . $zMite . "?page=" . $xaddress . "'><img src='common/media/" . $picname . ".jpg' border='0' class='icon-b' alt='" . $xtext . "'>" . $xtext . "</a><br>"; 
  echo "</div></p>";   
}
...
function fireImageJPEGof($zMite, $picname, $title, $size){
    ...
    <img src='common/media/" . $picname . ".jpg' 
    border='0' class='icon-ca' alt='" . $title . "' >" . $title . "</a></div>";
}

function fireImageJPEG($zMite, $picname, $title, $size){
    $dognap=($zMite . "?page=onfocus&wave=" . $picname);
    echo "<div class='icon-a'><a href='". $dognap ."'><img src='common/media/" . $picname . ".jpg' border='0' class='icon-b' ><br><br>" . $title . "</a></div>";
}

function fireImageJPEGjr($zMite, $picname, $title, $size){
    $dognap=($zMite . "?page=onfocus&wave=" . $picname);
    echo "<a href='". $dognap ."'><center><img src='common/media/" . $picname . ".jpg' border='0'    height='75' width='100%' ><br>" . $title . "</center></a><br>";
}
...
function fireDownJPEG($zWave, $zMite){
	...
	echo "<a href='common/media/". $zWave . ".jpg'>View</a> |<a href='common/media/images/content/". $zWave . ".jpg' download='". $zWave . "-pix-". $ztock . ".jpg'> Download</a> | <a href='#ContextInaBottle'>Notes</a> | 
	";
