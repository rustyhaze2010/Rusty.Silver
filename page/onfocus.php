...
<tr>
<td width="50%" height="30px"><?php echo fireLink("welcome", "welcome", $zMite); ?> >> <?php echo fireLink("projects","projects", $zMite); ?> </td>
<td width="50%" height="30px" align="right"><?php echo fireLink("contact","Contact Me", $zMite); ?> </td>
</tr>
<tr>
<td width="50%" height="30px" colspan="2" align="left"><h1><?php echo fireLink("about-me",$zAuthor, $zMite); ?>'s OnFocus...</h1></td>
</tr>
</table>  

<p><?php  fireImageJPEGof($zMite, $zWave, $zWave, 'large');?>


<div id="forward">
   
<p><?php  fireDownJPEG($zWave, $zMite);?>
    
<div id="ContextInaBottle">  
    
<p><?php  fireTextJPEG($zWave, $zMite);?>
