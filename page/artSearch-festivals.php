...
<div id="forward">
    ...
    <?php echo fireImageSEARCH( 'Cedar Falls IA festivals', 'cedar-falls'); ?> 
    <?php echo fireImageSEARCH( 'Cedar Rapids IA festivals', 'cedar-rapids'); ?> 
    <?php echo fireImageSEARCH( 'Waterloo IA festivals', 'waterloo'); ?> 
    <?php echo fireImageSEARCH( 'Des Moines IA festivals', 'des-moines'); ?> 
